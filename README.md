...
Além do objetivo proposto, este projeto apresenta o programa codificado em "português estruturado" indicado abaixo implementado em 20 linguagens de programação, destacando-se: Ada, Awk, BASIC (Free BASIC), C, C++, C#, Dart, FORTRAN-90, Go (Golang), Java, Julia, Kotlin, Lua, Pascal (Free Pascal), PHP, Perl, Python, Rust, Scala, Swift e VB.Net (BASIC).
